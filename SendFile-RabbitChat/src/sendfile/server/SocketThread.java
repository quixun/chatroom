            ...
            while (true) {
                ...
                switch (CMD) {
                    ...
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage(
                                "CMD_SHARINGSOCKET : Client thiết lập một socket cho kết nối chia sẻ file...");
                    ...
                    case "CMD_SENDFILE":
                        ...
                        if (cSock != null) { /* Exists */
                            ...
                            try {
                                ...
                                cDos.writeUTF("CMD_SENDFILE " + file_name + " " + filesize + " " +
                                        consignee);
                                /**
                    ...
                    case "CMD_SEND_FILE_ERROR": // Format: CMD_SEND_FILE_ERROR [receiver] [Message]
                        ...
                        try {
                            ...
                            Socket eSock = main.getClientFileSharingSocket(eReceiver); // phương thức nhận file sharing
                                                                                       // host socket cho kết nối
                    ...
                    case "CMD_SEND_FILE_ACCEPT": // Format: CMD_SEND_FILE_ACCEPT [receiver] [Message]
                        ...
                        try {
                            ...
                            Socket aSock = main.getClientFileSharingSocket(aReceiver); // get the file sharing host
